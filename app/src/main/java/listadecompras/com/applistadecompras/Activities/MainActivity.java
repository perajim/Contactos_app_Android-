...
import listadecompras.com.applistadecompras.Fragments.Derecha;
import listadecompras.com.applistadecompras.Fragments.ItemsFragment;
import listadecompras.com.applistadecompras.Fragments.ListaFragment;
...
public class MainActivity extends AppCompatActivity implements ListaFragment.CallBacks, ListaFragment.Refresh{
    ...
    public void onItemSelected(String nombrelista, String lista) {
        if (mTwoPane){
            ...
            getSupportFragmentManager().beginTransaction().replace(R.id.list_item,itemsFragment).
                    commit();
